# The format of annotations considered here is the same as the one provided by the Flickr27 dataset
# this code snippet is used to split the dataset into train, validation and test splits
# before running this, make sure you have the images and annotations in the same folder(if not, refer to the parser)
# file structure:
#   -images(folder)
#   -split.py
# this images folder should contain the images and annotations
import random
import shutil
